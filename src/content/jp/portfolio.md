...
ここでは、私のプロジェクトの一部を紹介します。このリストにある古いプロジェクトは、もうメンテナンスされていません。
...
- [Photon — ルーティング機能付き静的サイトビルダー](https://github.com/photon-framework)
- [Minecraft サーバー「Reost.de」のサイトです。](https://reost.de)
- [Magic — _JavaScript ブラウザアプリケーションに役立つもの_](https://www.npmjs.com/package/@frank-mayer/magic)
- [Popcorn Box — _DVD & Blu-ray 管理アプリ_](https://github.com/Frank-Mayer/popcornbox)

## 2020

- [AlwaysSmile — _Amazon Smile へのリダイレクト_](https://github.com/Frank-Mayer/AlwaysSmile)
- [CMapper — _クラス図エディタ_](https://cmapper.web.app)
